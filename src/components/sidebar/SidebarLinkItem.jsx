...
export default function SidebarLinkItem({
  ...
  return (
    <a
      ...
      className={`group inline-flex min-w-0 items-center gap-2 rounded-md text-sm text-slate-700 transition hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${className}`.trim()}
    >
